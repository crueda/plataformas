    ...
    <section class="content-header">
      <h1>
        ...
        if ($_GET["o2"]=='torque10dias') {
          echo 'Posiciones 10 días';
        } 
        else if ($_GET["o2"]=='municipios') {
          echo 'Municipios por número de posiciones';
        } 
        else if ($_GET["o2"]=='provincias') {
          echo 'Provincias por número de posiciones';
        } 
        else if ($_GET["o2"]=='pois_provincias') {
          echo 'Provincias por número de POIs';
        } 
        else {
          echo '';
        }
...
<iframe src="<?php 
      if ($_GET["o2"]=='torque10dias') {
        ...
        echo 'https://deimos-space.carto.com/u/kyros-lbs/builder/38763232-98b1-4651-838d-40c3363af42e/embed';
      }       
      else if ($_GET["o2"]=='municipios') {
        echo 'https://deimos-space.carto.com/u/kyros-lbs/builder/865e990a-30bd-11e7-9765-0e233c30368f/embed';
      }     
      else if ($_GET["o2"]=='pois_provincias') {
