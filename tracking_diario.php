...
<script type="text/javascript">
    ...
    title: {
        text: 'Puntos de tracking procesados en el día actual'
    },
    subtitle: {
        text: ''
    },
    ...
    xAxis: {
        categories: [<?php
echo file_get_contents( "./counters/kyros_trackings_diarios_x_axis.csv" ); 
?>],
labels: {
                            formatter: function () {
                                var d = new Date()
    ...
    series: [{
        name: 'Trackings',
        data: [<?php
echo file_get_contents( "./counters/kyros_trackings_diarios_y_axis.csv" ); 
?>]
    }]
});
