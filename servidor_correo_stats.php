  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Servidor de emails
        <small>    
        Estadísticas desde: <b>  <?php
$dateFile = file('./counters/mail_date_stats.log');
foreach ($dateFile as $line) {
  echo $line;              
}
?></b>
        </small>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Número de envios por dominio'
    },
    subtitle: {
        text: ''
    },
    ...
    series: [{
        name: 'Número de emails',
        data: [

        <?php
$statsFile = file('./counters/mail_domain_stats.log');
...
Highcharts.chart('container2', {
    ...
    title: {
        text: 'Número de envios por destinatario'
    },
    subtitle: {
        text: ''
    },
    ...
    tooltip: {
        pointFormat: 'Emails enviados: <b>{point.y:.0f}</b>'
    },
    series: [{
        name: 'Envíos',
        data: [
            <?php
$statsFile = file('./counters/mail_stats.log');
foreach ($statsFile as $line) {
  echo $line;              
}
?>
