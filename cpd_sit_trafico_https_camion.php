...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CPD del camión
        <small>Trafico de red (HTTPS)</small>
      </h1>
      <ol class="breadcrumb">
...
<iframe src="http://mykyros.es/pnp4nagios/index.php/graph?host=trafico-web-camion&srv=https%20sessions" frameborder="0" style="overflow: hidden; height: 85%;
