  ...
  <!--div class="box box-info">
    ...
    <div class="box-body">
        ...
        <div class="col-md-4 ">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <img width="100%" onload="this.style.display='block'" style="diplay:none" src="https://admin:m0rt4d3l0@correos.kyros.es/pnp4nagios/image?host=dmz-proxy-Virtual&amp;srv=https_sessions&amp;view=0&amp;source=0&amp;start=<?php echo time()-7800 ?>&amp;end=<?php echo time() ?>"/>
            </div>
      ...
      <div class="row">
        ...
        <script>
console.log ("----->" + "https://admin:m0rt4d3l0@hawkeye.kyroslbs.com/pnp4nagios/image?host=DB-stats&srv=Queries_average&amp;view=0&amp;source=0&amp;start=<?php echo time()-7800 ?>&amp;end=<?php echo time() ?>");
        </script>
        ...
        <div class="col-md-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <img id="pic" width="100%" src="https://admin:m0rt4d3l0@correos.kyros.es/traffic/internet-day.png" alt="Generando el gráfico..." title="Generando el gráfico..."/>              
            </div>
