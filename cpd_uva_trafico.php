...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <iframe src="./menu.php?o=cpd&o1=uva&o2=traficouva" frameborder="0" style="overflow: hidden; height: 90%;
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        CPD de la UVA
        <small>Trafico de red</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Menú</a></li>
        <li class="active">CPD UVA</li>
      </ol>
    </section>
...
<iframe src="https://correos.kyros.es/traffic/" frameborder="0" style="overflow: hidden; height: 85%;
        width: 100%; position: absolute;"></iframe>
